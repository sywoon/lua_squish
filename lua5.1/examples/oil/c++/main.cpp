...
{
	// legacy C++ object and wrapper that translates Hello methods into Lua methods
	Hello::HelloWorld *hello        = new Hello::HelloWorld(true);
	Hello::Wrapper    *wrappedHello = new Hello::Wrapper(hello);
	
	lua_State *L = newstate();
	
	// Lua wrapper class of 'Hello' class and Lua wrapper of 'hello' object
	Hello::Exported         *exportedClass = new Hello::Exported(L);
	Hello::Exported::Object *exportedHello = exportedClass->newObject(wrappedHello);
